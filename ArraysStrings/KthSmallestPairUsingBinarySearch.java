...
public class KthSmallestPairUsingBinarySearch {
    ...
    public static void main(String[] args) {
		int[] arr= {3,1,1,2,6,7,4};
		KthSmallestPairUsingBinarySearch k=new KthSmallestPairUsingBinarySearch();
		System.out.println(k.smallestDistancePair(arr, 3));
	}
}
