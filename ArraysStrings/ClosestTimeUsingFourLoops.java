...
import backtracking.ClosestTimeUsingDFS;

public class ClosestTimeUsingFourLoops {
	   public String nextClosestTime(String time) {
		...
		public static void main(String[] args) {
			ClosestTimeUsingFourLoops p=new ClosestTimeUsingFourLoops();
		
			String ans=p.nextClosestTime("23:59");
