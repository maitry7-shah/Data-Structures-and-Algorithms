...
public class ImplementPhoneDirectory {
	    ...
	    public void insert(String s)
	    {
	        ...
	        for (int i = 0; i < len; i++)
	        {
	            ...
	            // Trie
	            TrieNode nextNode = itr.map.get(s.charAt(i));
	            if (nextNode == null)
	            {
	                ...
	                itr.map.put(s.charAt(i),nextNode);
	            }
	                                   ...
	                                   String prefix)
	    {
	        ...
	        for (char i = 'a'; i <= 'z'; i++)
	        {
	            TrieNode nextNode = curNode.map.get(i);
	            if (nextNode != null)
	            {
	    ...
	    void displayContacts(String str)
	    {
	        ...
	        for (i = 0; i < len; i++)
	        {
	            ...
	            TrieNode curNode = prevNode.map.get(lastChar);
	    ...
	    {
	    	ImplementPhoneDirectory trie = new ImplementPhoneDirectory();
